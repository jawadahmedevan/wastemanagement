...
if(isset($_POST['done'])){
 ...
 $query1 = " INSERT INTO `authority`(`name`, `PhoneNumber`, `WorkingZone`, `DutyStarts`, `DutyEnds`) VALUES ('$name','$phone', '$wa', '$ds', '$de')";
...
<body>
    <div class="container">
        ...
        <div class="container">
            <div class="col-lg-12">
                <br><br>
                <h1 class="text-primary text-center"> Management Information </h1>
                <br>

                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
                    data-whatever="@mdo">Insert Management Info</button>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Insert Manager Info</h5>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="inputPassword4">Working Office Code</label>
...
?>
                ...
                <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#pinfo"
                    data-whatever="@mdo">Shift 1(10AM-6pm)</button>
                    <div class="modal fade" id="pinfo" tabindex="-1" role="dialog" aria-labelledby="pinfo" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Worker Available</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                        ...
                        $qq = "Select * from authority where DutyStarts='10:00:00';";
                ...
                <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#pinfo1"
                    data-whatever="@mdo">Shift 2(6PM-2AM)</button>
                    ...
                    <div class="modal-dialog" role="document">
                       ...
                       $qq2 = "Select * from authority where DutyStarts='18:00:00';";
                ...
                <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#pinfo2"
                    data-whatever="@mdo">Shift 3(2AM-10AM)</button>
                    ...
                    <div class="modal-dialog" role="document">
                       ...
                       $qq1 = "Select * from authority where DutyStarts='02:00:00';";
