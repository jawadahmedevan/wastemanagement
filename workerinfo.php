...
if(isset($_POST['done'])){
 ...
 $query1 = " INSERT INTO `worker`(`name`, `address`, `nid`, `bloodgroup`, `entryDate`, `dateofbirth`, `experienceDuration`, `CellNo`) VALUES ('$name','$address', '$nid', '$bg', '$ed', '$dob',  '$pd', '$cn')";
...
<body>
    <div class="container">
        ...
        <div class="container">
            <div class="col-lg-12">
                <br><br>
                <h1 class="text-primary text-center"> Worker Information </h1>
                <br>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Insert Worker Info</h5>
                            ...
                            <div class="modal-body">
                                <form method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4">Experience Duration</label>
...
$q = "select * from worker order by name";
...
?>
                    <tr class="text-center">
                        ...
                        <td>
                            <?php echo $res['experienceDuration'];  ?> Years </td>
                        <td>
                            <?php echo $res['CellNo'];  ?>
                        </td>
